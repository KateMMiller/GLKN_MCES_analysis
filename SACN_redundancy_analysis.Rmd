...
full_dat1 <- rbind(sacn2, metc_join) |> filter(year > 2006 & year < 2025) # GLKN sites only have data from 2007 - 2023
```
...
<li>Parameters dropped from redundancy analysis with notes: </li>
  <ul>
  <li><b>Alkalinity_mgL</b>: Little overlap in years across METC and GLKN </li>
  <li><b>Ca_mgL</b>: No new samples since 2020 in either dataset.</li>
  <li><b>DOC_mgL</b>: Little overlap in years across METC and GLKN. </li>
  <li><b>DOsat_pct</b>: Not included in METC data. Will use DO_mgL. </li>
  <li><b>K_mgL</b>: No new samples since 2020 in either dataset.</li>
  <li><b>Mg_mgL</b>: No new samples since 2020 in either dataset.</li>
  <li><b>Na_mgL</b>: No new samples since 2020 in either dataset.</li>
  <li><b>NH4_ugL</b>: No new samples since 2014 in METC.</li>
  <li><b>Si_mgL</b>: No new samples since 2021; periodic samples in GLKN sites </li>
  <li><b>Transp_cm</b>: No new samples since 2016; periodic samples in GLKN sites </li>
  </ul>
</ul>
...
param_site_mat <- rbind(chla, cl, do, nox, p, ph, sec, so4, sc, tmp, tss)
