...
core_sites <- c("METC_STCR_23.6", "SACN_STCR_20.0", "SACN_STCR_15.8", "SACN_STCR_2.0", "METC_STCR_0.1")
...
core_sites_abbr <- c("METC_23.6", "SACN_20.0", "SACN_15.8", "SACN_2.0", "METC_0.1")
...
```{r chnk84, echo = F}
wqdat <- dat2 |> select(date, station = site, param = param_name, value, doy, cont_year, yr = year, mo = month) |> 
  filter(!is.na(value))
```
...
chla_metc23.6 <- wqdat |> filter(param == "ChlA_ugL") |> filter(station == "METC_23.6")
chla_mod23.6 <- anlz_gam(chla_metc23.6)
anlz_smooth(chla_mod23.6)
anlz_fit(chla_mod23.6)
chla_metc23.6_doy <- show_prddoy(chla_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
chla_metc23.6_series <- show_prdseries(chla_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
chla_metc23.6_season <- show_prdseason(chla_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
chla_metc0.1 <- wqdat |> filter(param == "ChlA_ugL") |> filter(station == "METC_0.1")
chla_mod0.1 <- anlz_gam(chla_metc0.1)
anlz_smooth(chla_mod0.1)
anlz_fit(chla_mod0.1)
chla_metc0.1_doy <- show_prddoy(chla_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
chla_metc0.1_series <- show_prdseries(chla_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
chla_metc0.1_season <- show_prdseason(chla_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

chla_doy <- arrangeGrob(chla_metc23.6_doy, chla_sacn20.0_doy, chla_sacn15.8_doy, chla_sacn2.0_doy, chla_metc0.1_doy, ncol = 1)
chla_series <- arrangeGrob(chla_metc23.6_series, chla_sacn20.0_series, chla_sacn15.8_series, chla_sacn2.0_series, chla_metc0.1_series, ncol = 1)
chla_season <- arrangeGrob(chla_metc23.6_season, chla_sacn20.0_season, chla_sacn15.8_season, chla_sacn2.0_season, chla_metc0.1_season, ncol = 1)
```
</div><br>
...
cl_metc23.6 <- wqdat |> filter(param == "Cl_mgL") |> filter(station == "METC_23.6")
cl_mod23.6 <- anlz_gam(cl_metc23.6)
anlz_smooth(cl_mod23.6)
anlz_fit(cl_mod23.6)
cl_metc23.6_doy <- show_prddoy(cl_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
cl_metc23.6_series <- show_prdseries(cl_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
cl_metc23.6_season <- show_prdseason(cl_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
cl_metc0.1 <- wqdat |> filter(param == "Cl_mgL") |> filter(station == "METC_0.1")
cl_mod0.1 <- anlz_gam(cl_metc0.1)
anlz_smooth(cl_mod0.1)
anlz_fit(cl_mod0.1)
cl_metc0.1_doy <- show_prddoy(cl_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
cl_metc0.1_series <- show_prdseries(cl_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
cl_metc0.1_season <- show_prdseason(cl_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

cl_doy <- arrangeGrob(cl_metc23.6_doy, cl_sacn20.0_doy, cl_sacn15.8_doy, cl_sacn2.0_doy, cl_metc0.1_doy, ncol = 1)
cl_series <- arrangeGrob(cl_metc23.6_series, cl_sacn20.0_series, cl_sacn15.8_series, cl_sacn2.0_series, cl_metc0.1_series, ncol = 1)
cl_season <- arrangeGrob(cl_metc23.6_season, cl_sacn20.0_season, cl_sacn15.8_season, cl_sacn2.0_season, cl_metc0.1_season, ncol = 1)
```
</div><br>
...
doc_metc23.6 <- wqdat |> filter(param == "DOC_mgL") |> filter(station == "METC_23.6")
doc_mod23.6 <- anlz_gam(doc_metc23.6)
anlz_smooth(doc_mod23.6)
anlz_fit(doc_mod23.6)
doc_metc23.6_doy <- show_prddoy(doc_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
doc_metc23.6_series <- show_prdseries(doc_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
doc_metc23.6_season <- show_prdseason(doc_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
doc_metc0.1 <- wqdat |> filter(param == "DOC_mgL") |> filter(station == "METC_0.1")
doc_mod0.1 <- anlz_gam(doc_metc0.1)
anlz_smooth(doc_mod0.1)
anlz_fit(doc_mod0.1)
doc_metc0.1_doy <- show_prddoy(doc_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
doc_metc0.1_series <- show_prdseries(doc_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
doc_metc0.1_season <- show_prdseason(doc_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

doc_doy <- arrangeGrob(doc_metc23.6_doy, doc_sacn20.0_doy, doc_sacn15.8_doy, doc_sacn2.0_doy, doc_metc0.1_doy, ncol = 1)
doc_series <- arrangeGrob(doc_metc23.6_series, doc_sacn20.0_series, doc_sacn15.8_series, doc_sacn2.0_series, doc_metc0.1_series, ncol = 1)
doc_season <- arrangeGrob(doc_metc23.6_season, doc_sacn20.0_season, doc_sacn15.8_season, doc_sacn2.0_season, doc_metc0.1_season, ncol = 1)
```
</div><br>
...
ylabel = "NO2 + NO3 (ug/L)"
nox_metc23.6 <- wqdat |> filter(param == "NO2+NO3_ugL") |> filter(station == "METC_23.6")
nox_mod23.6 <- anlz_gam(nox_metc23.6)
anlz_smooth(nox_mod23.6)
anlz_fit(nox_mod23.6)
nox_metc23.6_doy <- show_prddoy(nox_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
nox_metc23.6_series <- show_prdseries(nox_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
nox_metc23.6_season <- show_prdseason(nox_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
nox_metc0.1 <- wqdat |> filter(param == "NO2+NO3_ugL") |> filter(station == "METC_0.1")
nox_mod0.1 <- anlz_gam(nox_metc0.1)
anlz_smooth(nox_mod0.1)
anlz_fit(nox_mod0.1)
nox_metc0.1_doy <- show_prddoy(nox_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
nox_metc0.1_series <- show_prdseries(nox_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
nox_metc0.1_season <- show_prdseason(nox_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

nox_doy <- arrangeGrob(nox_metc23.6_doy, nox_sacn20.0_doy, nox_sacn15.8_doy, nox_sacn2.0_doy, nox_metc0.1_doy, ncol = 1)
nox_series <- arrangeGrob(nox_metc23.6_series, nox_sacn20.0_series, nox_sacn15.8_series, nox_sacn2.0_series, nox_metc0.1_series, ncol = 1)
nox_season <- arrangeGrob(nox_metc23.6_season, nox_sacn20.0_season, nox_sacn15.8_season, nox_sacn2.0_season, nox_metc0.1_season, ncol = 1)
```
</div><br>
...
tp_metc23.6 <- wqdat |> filter(param == "P_ugL") |> filter(station == "METC_23.6")
tp_mod23.6 <- anlz_gam(tp_metc23.6)
anlz_smooth(tp_mod23.6)
anlz_fit(tp_mod23.6)
tp_metc23.6_doy <- show_prddoy(tp_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
tp_metc23.6_series <- show_prdseries(tp_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
tp_metc23.6_season <- show_prdseason(tp_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
tp_metc0.1 <- wqdat |> filter(param == "P_ugL") |> filter(station == "METC_0.1")
tp_mod0.1 <- anlz_gam(tp_metc0.1)
anlz_smooth(tp_mod0.1)
anlz_fit(tp_mod0.1)
tp_metc0.1_doy <- show_prddoy(tp_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
tp_metc0.1_series <- show_prdseries(tp_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
tp_metc0.1_season <- show_prdseason(tp_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

tp_doy <- arrangeGrob(tp_metc23.6_doy, tp_sacn20.0_doy, tp_sacn15.8_doy, tp_sacn2.0_doy, tp_metc0.1_doy, ncol = 1)
tp_series <- arrangeGrob(tp_metc23.6_series, tp_sacn20.0_series, tp_sacn15.8_series, tp_sacn2.0_series, tp_metc0.1_series, ncol = 1)
tp_season <- arrangeGrob(tp_metc23.6_season, tp_sacn20.0_season, tp_sacn15.8_season, tp_sacn2.0_season, tp_metc0.1_season, ncol = 1)
```
</div><br>
...
ylabel = "pH"
pH_metc23.6 <- wqdat |> filter(param == "pH") |> filter(station == "METC_23.6")
pH_mod23.6 <- anlz_gam(pH_metc23.6)
anlz_smooth(pH_mod23.6)
anlz_fit(pH_mod23.6)
pH_metc23.6_doy <- show_prddoy(pH_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
pH_metc23.6_series <- show_prdseries(pH_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
pH_metc23.6_season <- show_prdseason(pH_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
pH_metc0.1 <- wqdat |> filter(param == "pH") |> filter(station == "METC_0.1")
pH_mod0.1 <- anlz_gam(pH_metc0.1)
anlz_smooth(pH_mod0.1)
anlz_fit(pH_mod0.1)
pH_metc0.1_doy <- show_prddoy(pH_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
pH_metc0.1_series <- show_prdseries(pH_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
pH_metc0.1_season <- show_prdseason(pH_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

pH_doy <- arrangeGrob(pH_metc23.6_doy, pH_sacn20.0_doy, pH_sacn15.8_doy, pH_sacn2.0_doy, pH_metc0.1_doy, ncol = 1)
pH_series <- arrangeGrob(pH_metc23.6_series, pH_sacn20.0_series, pH_sacn15.8_series, pH_sacn2.0_series, pH_metc0.1_series, ncol = 1)
pH_season <- arrangeGrob(pH_metc23.6_season, pH_sacn20.0_season, pH_sacn15.8_season, pH_sacn2.0_season, pH_metc0.1_season, ncol = 1)
```
</div><br>
...
ylabel = "Sulfate (mg/L)"
so4_metc23.6 <- wqdat |> filter(param == "SO4_mgL") |> filter(station == "METC_23.6")
so4_mod23.6 <- anlz_gam(so4_metc23.6)
anlz_smooth(so4_mod23.6)
anlz_fit(so4_mod23.6)
so4_metc23.6_doy <- show_prddoy(so4_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
so4_metc23.6_series <- show_prdseries(so4_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
so4_metc23.6_season <- show_prdseason(so4_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
so4_metc0.1 <- wqdat |> filter(param == "SO4_mgL") |> filter(station == "METC_0.1")
so4_mod0.1 <- anlz_gam(so4_metc0.1)
anlz_smooth(so4_mod0.1)
anlz_fit(so4_mod0.1)
so4_metc0.1_doy <- show_prddoy(so4_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
so4_metc0.1_series <- show_prdseries(so4_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
so4_metc0.1_season <- show_prdseason(so4_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

so4_doy <- arrangeGrob(so4_metc23.6_doy, so4_sacn20.0_doy, so4_sacn15.8_doy, so4_sacn2.0_doy, so4_metc0.1_doy, ncol = 1)
so4_series <- arrangeGrob(so4_metc23.6_series, so4_sacn20.0_series, so4_sacn15.8_series, so4_sacn2.0_series, so4_metc0.1_series, ncol = 1)
so4_season <- arrangeGrob(so4_metc23.6_season, so4_sacn20.0_season, so4_sacn15.8_season, so4_sacn2.0_season, so4_metc0.1_season, ncol = 1)
```
</div><br>
...
spec_metc23.6 <- wqdat |> filter(param == "SpecCond_uScm") |> filter(station == "METC_23.6")
spec_mod23.6 <- anlz_gam(spec_metc23.6)
anlz_smooth(spec_mod23.6)
anlz_fit(spec_mod23.6)
spec_metc23.6_doy <- show_prddoy(spec_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
spec_metc23.6_series <- show_prdseries(spec_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
spec_metc23.6_season <- show_prdseason(spec_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
spec_metc0.1 <- wqdat |> filter(param == "SpecCond_uScm") |> filter(station == "METC_0.1")
spec_mod0.1 <- anlz_gam(spec_metc0.1)
anlz_smooth(spec_mod0.1)
anlz_fit(spec_mod0.1)
spec_metc0.1_doy <- show_prddoy(spec_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
spec_metc0.1_series <- show_prdseries(spec_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
spec_metc0.1_season <- show_prdseason(spec_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

spec_doy <- arrangeGrob(spec_metc23.6_doy, spec_sacn20.0_doy, spec_sacn15.8_doy, spec_sacn2.0_doy, spec_metc0.1_doy, ncol = 1)
spec_series <- arrangeGrob(spec_metc23.6_series, spec_sacn20.0_series, spec_sacn15.8_series, spec_sacn2.0_series, spec_metc0.1_series, ncol = 1)
spec_season <- arrangeGrob(spec_metc23.6_season, spec_sacn20.0_season, spec_sacn15.8_season, spec_sacn2.0_season, spec_metc0.1_season, ncol = 1)
```
</div><br>
...
wtmp_metc23.6 <- wqdat |> filter(param == "TempWater_C") |> filter(station == "METC_23.6")
wtmp_mod23.6 <- anlz_gam(wtmp_metc23.6)
anlz_smooth(wtmp_mod23.6)
anlz_fit(wtmp_mod23.6)
wtmp_metc23.6_doy <- show_prddoy(wtmp_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
wtmp_metc23.6_series <- show_prdseries(wtmp_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
wtmp_metc23.6_season <- show_prdseason(wtmp_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
wtmp_metc0.1 <- wqdat |> filter(param == "TempWater_C") |> filter(station == "METC_0.1")
wtmp_mod0.1 <- anlz_gam(wtmp_metc0.1)
anlz_smooth(wtmp_mod0.1)
anlz_fit(wtmp_mod0.1)
wtmp_metc0.1_doy <- show_prddoy(wtmp_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
wtmp_metc0.1_series <- show_prdseries(wtmp_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
wtmp_metc0.1_season <- show_prdseason(wtmp_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

wtmp_doy <- arrangeGrob(wtmp_metc23.6_doy, wtmp_sacn20.0_doy, wtmp_sacn15.8_doy, wtmp_sacn2.0_doy, wtmp_metc0.1_doy, ncol = 1)
wtmp_series <- arrangeGrob(wtmp_metc23.6_series, wtmp_sacn20.0_series, wtmp_sacn15.8_series, wtmp_sacn2.0_series, wtmp_metc0.1_series, ncol = 1)
wtmp_season <- arrangeGrob(wtmp_metc23.6_season, wtmp_sacn20.0_season, wtmp_sacn15.8_season, wtmp_sacn2.0_season, wtmp_metc0.1_season, ncol = 1)
```
</div><br>
...
tss_metc23.6 <- wqdat |> filter(param == "TSS_mgL") |> filter(station == "METC_23.6")
tss_mod23.6 <- anlz_gam(tss_metc23.6)
anlz_smooth(tss_mod23.6)
anlz_fit(tss_mod23.6)
tss_metc23.6_doy <- show_prddoy(tss_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
tss_metc23.6_series <- show_prdseries(tss_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
tss_metc23.6_season <- show_prdseason(tss_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
tss_metc0.1 <- wqdat |> filter(param == "TSS_mgL") |> filter(station == "METC_0.1")
tss_mod0.1 <- anlz_gam(tss_metc0.1)
anlz_smooth(tss_mod0.1)
anlz_fit(tss_mod0.1)
tss_metc0.1_doy <- show_prddoy(tss_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
tss_metc0.1_series <- show_prdseries(tss_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
tss_metc0.1_season <- show_prdseason(tss_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

tss_doy <- arrangeGrob(tss_metc23.6_doy, tss_sacn20.0_doy, tss_sacn15.8_doy, tss_sacn2.0_doy, tss_metc0.1_doy, ncol = 1)
tss_series <- arrangeGrob(tss_metc23.6_series, tss_sacn20.0_series, tss_sacn15.8_series, tss_sacn2.0_series, tss_metc0.1_series, ncol = 1)
tss_season <- arrangeGrob(tss_metc23.6_season, tss_sacn20.0_season, tss_sacn15.8_season, tss_sacn2.0_season, tss_metc0.1_season, ncol = 1)
```
</div><br>
...
alk_metc23.6 <- wqdat |> filter(param == "Alkalinity_mgL") |> filter(station == "METC_23.6")
alk_mod23.6 <- anlz_gam(alk_metc23.6)
anlz_smooth(alk_mod23.6)
anlz_fit(alk_mod23.6)
alk_metc23.6_doy <- show_prddoy(alk_mod23.6, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
alk_metc23.6_series <- show_prdseries(alk_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
alk_metc23.6_season <- show_prdseason(alk_mod23.6, ylab = ylabel) + labs(title = "Site: METC_23.6") + theme(legend.position = 'none')
...
alk_metc0.1 <- wqdat |> filter(param == "Alkalinity_mgL") |> filter(station == "METC_0.1")
alk_mod0.1 <- anlz_gam(alk_metc0.1)
anlz_smooth(alk_mod0.1)
anlz_fit(alk_mod0.1)
alk_metc0.1_doy <- show_prddoy(alk_mod0.1, ylab = ylabel, size = 1.5) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
alk_metc0.1_series <- show_prdseries(alk_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')
alk_metc0.1_season <- show_prdseason(alk_mod0.1, ylab = ylabel) + labs(title = "Site: METC_0.1") + theme(legend.position = 'bottom')

alk_doy <- arrangeGrob(alk_metc23.6_doy, alk_sacn20.0_doy, alk_sacn15.8_doy, alk_sacn2.0_doy, alk_metc0.1_doy, ncol = 1)
alk_series <- arrangeGrob(alk_metc23.6_series, alk_sacn20.0_series, alk_sacn15.8_series, alk_sacn2.0_series, alk_metc0.1_series, ncol = 1)
alk_season <- arrangeGrob(alk_metc23.6_season, alk_sacn20.0_season, alk_sacn15.8_season, alk_sacn2.0_season, alk_metc0.1_season, ncol = 1)
```
</div><br>
...
```{r lake_prof, echo = F, out.width = "100%", eval = F, fig.height = 10, fig.cap = "Lake plot of parameter by sample depth in 1m bins."}
prof_p <- plotLakeProfile(site = lksc, parameter = prm)
print(prof_p)
```
...
for(i in seq_along(prof_list)){
  prm <- prof_list[[i]]
  cat("##### ", prm, "\n\n")
  cat(paste0("Profile plot of <b>", prm, "</b> by sample depth in 1m bins."))
  <<lake_prof>>
  cat("\n\n")
  cat("\n\n")
}
