...
param_site_mat <- rbind(
  data.frame(Location_ID = core_sites, param_name = "Alkalinity_mgL"),
  data.frame(Location_ID = all_sites, param_name = "ChlA_ugL"),
  data.frame(Location_ID = core_sites, param_name = "Cl_mgL"),
  data.frame(Location_ID = core_sites, param_name = "DOC_mgL"),
  data.frame(Location_ID = core_sites, param_name = "DO_mgL"),
  data.frame(Location_ID = core_sites, param_name = "NO2+NO3_ugL"),
  data.frame(Location_ID = core_sites, param_name = "P_ugL"),
  data.frame(Location_ID = core_sites, param_name = "pH"),
  data.frame(Location_ID = all_sites, param_name = "Secchi_m"),
  data.frame(Location_ID = core_sites, param_name = "SO4_mgL"),
  data.frame(Location_ID = core_sites, param_name = "SpecCond_uScm"),
  data.frame(Location_ID = all_sites, param_name = "TempWater_C"),
  data.frame(Location_ID = core_sites, param_name = "TSS_mgL"))

core_params <- unique(param_site_mat$param_name[param_site_mat$Location_ID == "METC_STCR_23.6"])
```
</div><br>
...
#### gamms on core params/sites {.tabset}
```{r echo = F}
...
chla_doy <- grid.arrange(chla_metc23.6_doy, chla_sacn20.0_doy, chla_sacn15.8_doy, chla_sacn2.0_doy, chla_metc0.1_doy, ncol = 1)
chla_series <- grid.arrange(chla_metc23.6_series, chla_sacn20.0_series, chla_sacn15.8_series, chla_sacn2.0_series, chla_metc0.1_series, ncol = 1)
chla_season <- grid.arrange(chla_metc23.6_season, chla_sacn20.0_season, chla_sacn15.8_season, chla_sacn2.0_season, chla_metc0.1_season, ncol = 1)
```
</div><br>

```{r echo = F, fig.height = 10, fig.width=8, fig.cap = "GAM by day of year."}
chla_doy
```

```{r echo = F, fig.height = 10, fig.width=8, fig.cap = "GAM by time series."}
chla_series
```

```{r echo = F, fig.height = 10, fig.width=8, fig.cap = "GAM by season."}
chla_season
```
...
doc_doy <- grid.arrange(doc_metc23.6_doy, doc_sacn20.0_doy, doc_sacn15.8_doy, doc_sacn2.0_doy, doc_metc0.1_doy, ncol = 1)
doc_series <- grid.arrange(doc_metc23.6_series, doc_sacn20.0_series, doc_sacn15.8_series, doc_sacn2.0_series, doc_metc0.1_series, ncol = 1)
doc_season <- grid.arrange(doc_metc23.6_season, doc_sacn20.0_season, doc_sacn15.8_season, doc_sacn2.0_season, doc_metc0.1_season, ncol = 1)
```
</div><br>
...
nox_doy <- grid.arrange(nox_metc23.6_doy, nox_sacn20.0_doy, nox_sacn15.8_doy, nox_sacn2.0_doy, nox_metc0.1_doy, ncol = 1)
nox_series <- grid.arrange(nox_metc23.6_series, nox_sacn20.0_series, nox_sacn15.8_series, nox_sacn2.0_series, nox_metc0.1_series, ncol = 1)
nox_season <- grid.arrange(nox_metc23.6_season, nox_sacn20.0_season, nox_sacn15.8_season, nox_sacn2.0_season, nox_metc0.1_season, ncol = 1)
```
</div><br>
...
tp_doy <- grid.arrange(tp_metc23.6_doy, tp_sacn20.0_doy, tp_sacn15.8_doy, tp_sacn2.0_doy, tp_metc0.1_doy, ncol = 1)
tp_series <- grid.arrange(tp_metc23.6_series, tp_sacn20.0_series, tp_sacn15.8_series, tp_sacn2.0_series, tp_metc0.1_series, ncol = 1)
tp_season <- grid.arrange(tp_metc23.6_season, tp_sacn20.0_season, tp_sacn15.8_season, tp_sacn2.0_season, tp_metc0.1_season, ncol = 1)
```
</div><br>
...
pH_doy <- grid.arrange(pH_metc23.6_doy, pH_sacn20.0_doy, pH_sacn15.8_doy, pH_sacn2.0_doy, pH_metc0.1_doy, ncol = 1)
pH_series <- grid.arrange(pH_metc23.6_series, pH_sacn20.0_series, pH_sacn15.8_series, pH_sacn2.0_series, pH_metc0.1_series, ncol = 1)
pH_season <- grid.arrange(pH_metc23.6_season, pH_sacn20.0_season, pH_sacn15.8_season, pH_sacn2.0_season, pH_metc0.1_season, ncol = 1)
```
</div><br>
...
so4_doy <- grid.arrange(so4_metc23.6_doy, so4_sacn20.0_doy, so4_sacn15.8_doy, so4_sacn2.0_doy, so4_metc0.1_doy, ncol = 1)
so4_series <- grid.arrange(so4_metc23.6_series, so4_sacn20.0_series, so4_sacn15.8_series, so4_sacn2.0_series, so4_metc0.1_series, ncol = 1)
so4_season <- grid.arrange(so4_metc23.6_season, so4_sacn20.0_season, so4_sacn15.8_season, so4_sacn2.0_season, so4_metc0.1_season, ncol = 1)
```
</div><br>
...
spec_doy <- grid.arrange(spec_metc23.6_doy, spec_sacn20.0_doy, spec_sacn15.8_doy, spec_sacn2.0_doy, spec_metc0.1_doy, ncol = 1)
spec_series <- grid.arrange(spec_metc23.6_series, spec_sacn20.0_series, spec_sacn15.8_series, spec_sacn2.0_series, spec_metc0.1_series, ncol = 1)
spec_season <- grid.arrange(spec_metc23.6_season, spec_sacn20.0_season, spec_sacn15.8_season, spec_sacn2.0_season, spec_metc0.1_season, ncol = 1)
```
</div><br>
...
tss_doy <- grid.arrange(tss_metc23.6_doy, tss_sacn20.0_doy, tss_sacn15.8_doy, tss_sacn2.0_doy, tss_metc0.1_doy, ncol = 1)
tss_series <- grid.arrange(tss_metc23.6_series, tss_sacn20.0_series, tss_sacn15.8_series, tss_sacn2.0_series, tss_metc0.1_series, ncol = 1)
tss_season <- grid.arrange(tss_metc23.6_season, tss_sacn20.0_season, tss_sacn15.8_season, tss_sacn2.0_season, tss_metc0.1_season, ncol = 1)
```
</div><br>
...
alk_doy <- grid.arrange(alk_metc23.6_doy, alk_sacn20.0_doy, alk_sacn15.8_doy, alk_sacn2.0_doy, alk_metc0.1_doy, ncol = 1)
alk_series <- grid.arrange(alk_metc23.6_series, alk_sacn20.0_series, alk_sacn15.8_series, alk_sacn2.0_series, alk_metc0.1_series, ncol = 1)
alk_season <- grid.arrange(alk_metc23.6_season, alk_sacn20.0_season, alk_sacn15.8_season, alk_sacn2.0_season, alk_metc0.1_season, ncol = 1)
```
</div><br>
...
### Notes
Things to check on
1. Depth not always recorded in GLKN data. Where not recorded, appears to be metrics that are only collected at one depth. Make sure this is true.
2. Consider changing ChlA-ugL, Nh4_ugL, NO2+NO3_ugL, P_ugL to mgL, because METC data are reported in mgL and only have 2 significant figures. Makes the data look discrete on a plot when it's really not.
