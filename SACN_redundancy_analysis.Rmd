...
full_dat$site_abbr <- factor(gsub("_STCR", "", full_dat$Location_ID),
                             levels = c("METC_23.6", "METC_23.4", "METC_22.5", "METC_22.3",
...
params_site_year <- full_dat |> group_by(Site = site_abbr, Parameter = param_name, Year = year) |> 
...
# heat map seems easier, so not printing this to markdown
