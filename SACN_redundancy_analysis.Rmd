...
```{r echo = F, fig.height = 12, fig.width=8, fig.cap = "GAM by day of year."}
grid.draw(chla_doy)
```

###### Month by year {.tabset}
```{r echo = F, fig.height = 12, fig.width=8, fig.cap = "GAM month by year."}
grid.draw(chla_season)
```

###### Full time series {.tabset}
```{r echo = F, fig.height = 12, fig.width=8, fig.cap = "GAM full time series."}
